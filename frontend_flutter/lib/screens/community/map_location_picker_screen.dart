...
class PickedLocation {
  final double lat;
  final double lng;
  final String? label; // optional address/label the user typed
...
///
/// Optionally accepts an initial [initialPosition] and [initialLabel].
/// Returns a [PickedLocation] via Navigator.pop on confirm, or null on cancel.
          ...
          if (_selectedPoint != null)
            Positioned(
              ...
              child: Container(
                ...
                child: Row(
                  children: [
                    const Icon(Icons.push_pin, color: Color(0xFFD32F2F), size: 18),
                ...
                children: [
                  TextField(
                    ...
                    decoration: InputDecoration(
                      hintText: 'Optional: add a label (e.g. "near bus stop")',
